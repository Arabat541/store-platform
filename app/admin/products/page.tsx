        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl shadow-primary/10 w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 m-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Images du produit</label>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {imagePreviews.map((src, i) => (
                      <div key={`new-${i}`} className="relative group w-20 h-20">
                        <img src={src} alt="" className="w-20 h-20 object-cover rounded-lg border-2 border-primary/30" />
                        <button
                          type="button"
                ...
                <p className="text-xs text-slate-400 mt-1">JPEG, PNG, WebP, GIF — max 5 Mo par image</p>
              </div>
              ...
              <div className="flex gap-3 justify-end pt-4">
                ...
                <button type="submit" disabled={uploading} className="px-4 py-2.5 text-sm bg-primary text-white rounded-lg hover:bg-primary/90 shadow-lg shadow-primary/20 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed">
